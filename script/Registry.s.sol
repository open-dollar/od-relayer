...
address constant MAINNET_CAMELOT_RELAYER_FACTORY = 0x0000000000000000000000000000000000000000;
address constant MAINNET_CHAINLINK_RELAYER_FACTORY = 0x0000000000000000000000000000000000000000;
address constant MAINNET_DENOMINATED_ORACLE_FACTORY = 0x0000000000000000000000000000000000000000;

// Relayers
address constant MAINNET_CAMELOT_ODG_WETH_RELAYER = 0x0000000000000000000000000000000000000000;

address constant MAINNET_CHAINLINK_ETH_USD_RELAYER = 0x0000000000000000000000000000000000000000;
...
address constant MAINNET_DENOMINATED_ODG_USD_ORACLE = 0x0000000000000000000000000000000000000000;
address constant MAINNET_DENOMINATED_RETH_USD_ORACLE = 0x0000000000000000000000000000000000000000;
address constant MAINNET_DENOMINATED_WSTETH_USD_ORACLE = 0x0000000000000000000000000000000000000000;

// Oracles params
uint256 constant MAINNET_ORACLE_INTERVAL = 1 hours;

// Chainlink price feeds to USD
address constant MAINNET_CHAINLINK_ARB_USD_FEED = 0xb2A824043730FE05F3DA2efaFa1CBbe83fa548D6; //updated every few minutes
address constant MAINNET_CHAINLINK_ETH_USD_FEED = 0x639Fe6ab55C921f74e7fac1ee960C0B6293ba612; //updated every few minutes

// Chainlink price feeds to ETH
address constant MAINNET_CHAINLINK_WSTETH_ETH_FEED = 0xb523AE262D20A936BC152e6023996e46FDC2A95D; //updated once a day
address constant MAINNET_CHAINLINK_RETH_ETH_FEED = 0xD6aB2298946840262FcC278fF31516D39fF611eF; //updated every month or less sometimes
